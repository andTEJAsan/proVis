...
def products_queryid_reviews_get(puid):  # noqa: E501
    """get a list of all Reviews of a specific product

    fetches all Reviews of a specific product # noqa: E501

    :param id: ID of product whose bookmark is needed
    :type id: str

    :rtype: List[Reviews]
    """

    return db.getreviews_frompuid(puid)


def products_queryid_reviews_post(body):  # noqa: E501
    ...
    :param id: ID of product for which new review has to be added
    :type id: str
...
def products_queryid_reviews_reviewid_delete(puid, reviewid):  # noqa: E501
    """deletes a specific product&#x27;s review by id of both

    deletes a specific product&#x27;s review by id of both # noqa: E501

    :param id: ID of product whose review needs to be deleted
    :type id: str
    ...
    :rtype: None
    """
    db.deletereviews_fromreviewid(puid,reviewid)
