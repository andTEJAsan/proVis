...
def delete_customer_bookmark(id, bookmarkid):  # noqa: E501
    ...
    """
    db.delete_customer_bookmark(id=id,bookmarkid=bookmarkid)
...
def get_customer_bookmark(id, bookmarkid):  # noqa: E501
    ...
    :rtype: Bookmarks
    """
    db.get_customer_bookmark(id=id,bookmarkid=bookmarkid)
    return 'do some magic!'
...
def get_customer_bookmarks(id):  # noqa: E501
    ...
    """
    return db.get_customer_bookmarks(id=id)
...
def post_bookmark(body, id):  # noqa: E501
    ...
    if connexion.request.is_json:
        ...
        db.post_bookmark(bookmark=body,id=id)
    return 'do some magic!'
